...
# App lock permission
PRODUCT_COPY_FILES += \
    vendor/lessaosp/config/permissions/privapp-permissions-settings.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-settings.xml
...
# Lineage Hardware
PRODUCT_COPY_FILES += \
    vendor/lessaosp/config/permissions/privapp-permissions-lineagehw.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-lineagehw.xml \
    vendor/lessaosp/config/permissions/org.lineageos.health.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/org.lineageos.health.xml
...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(LESSAOSP_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml rild Calendar Launcher3 Launcher3Go Launcher3QuickStep Launcher3QuickStepGo android.hidl.memory@1.0-impl.vendor vndk_apex_snapshot_package)
endif
...
PRODUCT_COPY_FILES += \
    vendor/lessaosp/config/permissions/com.google.android.apps.dialer.call_recording_audio.features.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/com.google.android.apps.dialer.call_recording_audio.features.xml
endif
...
PRODUCT_COPY_FILES += \
    vendor/lessaosp/prebuilt/common/bin/clean_cache.sh:system/bin/clean_cache.sh
...
PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/lessaosp/build/target/product/security/lessaosp
...
PRODUCT_COPY_FILES += \
    vendor/lessaosp/pocket/privapp-permissions-pocketmode.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-pocketmode.xml

include vendor/lessaosp/config/ota.mk
include vendor/lessaosp/config/pixel_props.mk
